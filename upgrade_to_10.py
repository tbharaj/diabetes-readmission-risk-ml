...
Path("src/readmission_pipeline.py").write_text(code, encoding="utf-8")

print("Advanced 10/10 pipeline written to src/readmission_pipeline.py")
print("Next run:")
print(r".\.venv\Scripts\python.exe src\readmission_pipeline.py")
